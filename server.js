...
app.get('/team_stats', function(req, res) {
	...
	var wins = 'select COUNT(*) AS winGames from football_games WHERE home_score > visitor_score;';
...
//	var query3 = 'select * from table_name_3;';
	var playerID = req.query.player_choice.value;
